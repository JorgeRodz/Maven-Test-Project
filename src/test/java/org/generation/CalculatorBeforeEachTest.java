...
class CalculatorBeforeEachTest {
    ...
    @DisplayName("Sumatoria de numeros de punto flotante positivos")
    @Test
    void addDoubleTest() {
    ...
    void divisionTest() {
        ...
        assertEquals(17,  cal.division(70, 4),   "Division 70 entre 4 debe ser 17"); // división entera
